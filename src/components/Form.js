  ...
  return (
    <div className="Form">
      ...
      {isAwardsEnabled ? (
        ...
        <button className={"text-white  w-full py-1 " + (isAwardsEnabled ? "bg-red-100 hover:bg-red-300 rounded-b-lg":"bg-green-600 hover:bg-green-500 rounded-sm")} onClick={toggleAward}>
